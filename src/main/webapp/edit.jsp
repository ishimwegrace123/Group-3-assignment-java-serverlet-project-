        ...
        <nav class="navbar navbar-default header navbar-fixed-top">
            ...
            <div class="navbar-header" style="width:100%;">
              ...
              <ul class="nav navbar-nav navbar-right user-nav">
                <li class="user-name"><span>MY ACCOUNT</span></li>
...
<input type="submit" class="form-control" value="logout" style="width:100px;  background-color: skyblue;"></form></li>
  ...
  <div class="card-body px-0 pb-2">
           ...
           <h3>There is only one boss. The customer. And he can fire everybody in the company from the chairman on down, simply by spending his money somewhere else.</h3>
                <div class="col-md-12">
                  <div class="panel">
                    <div class="panel-heading"><h3>Edit reservations for <%=rs.getString("fname")  %> <%=rs.getString("sname") %></h3></div>
                    ...
                    <div class="panel-body">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                        <input type="text" name="sname" class="form-control" id="name" value="<%=rs.getString("fname") %>">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <input type="text" name="sname" class="form-control" id="name" value="<%=rs.getString("sname") %>">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <input type="text" name="phnumber" class="form-control" id="name" value="<%=rs.getString("phnumber") %>">
                        </div>
                      </div>
                       <div class="form-group">
                        <label class="control-label col-sm-2" for="email">Local_Adress</label>
                        <div class="col-sm-10">
                          <input type="text" name="adress" class="form-control" id="name" value="<%=rs.getString("adress") %>">
                        </div>
                      </div>
                          <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          ...
                          <input type="text" name="from" class="form-control" id="name" value="Kigali">
                          <br>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                        <input type="select" name="to" class="form-control" id="name" value="<%=rs.getString("to") %>">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <input type="date" name="date" class="form-control" id="name" value="<%=rs.getString("date") %>">
                        </div>
                      </div>
                         <div class="form-group">
                        <label class="control-label col-sm-2" for="returndate" >Flight_Name:</label>
                        <div class="col-sm-10">
                          <input type="text" name="flytname" class="form-control" id="name" value="<%=rs.getString("flytname") %>">
                        </div>
                      </div>
                        ...
                        <div class="col-sm-10">
                         <input type="text" name="sitplace" class="form-control" id="name" value="<%=rs.getString("sitplace") %>">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-10">
                         <a href="ind.jsp"> <input type="button" value="Save" class="btn btn-info" onclick="myFunction()"></a> <a href="ind.jsp"> <input type="button" value="cancel" class="btn btn-info"></a>
                        </div>
                        <script>
function myFunction() {
  alert("<%=rs.getString("fname") %> successful Updated" );
