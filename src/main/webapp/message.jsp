              ...
              <div class="sub-left-menu scroll">
                <ul class="nav nav-list">
                   ...
                   <a  href="addreserve.jsp"class="tree-toggle nav-header"> Add reservations here</a>
                    ...
                    <a  href="#"class="tree-toggle nav-header active"> View Guest messages</a>
  ...
  <div class="card-body px-0 pb-2">
           ...
           <h3>There is only one boss. The customer. And he can fire everybody in the company from the chairman on down, simply by spending his money somewhere else.</h3>
               ...
               %>
                      ...
                      <td>
                        <p class="text-sm font-weight-bold mb-0"><%=rs.getString("msg_id") %></p>
                      </td>
                      <td>
                       <p class="text-sm font-weight-bold mb-0"><%=rs.getString("fullname") %></p>
                     
                      </td>
                     <td>
                       <p class="text-sm font-weight-bold mb-0"><%=rs.getString("phonnumber") %></p>
                      ...
                      <td>
                       <p class="text-sm font-weight-bold mb-0"><%=rs.getString("msgcontent") %></p>
